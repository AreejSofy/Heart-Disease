...
if st.button("🔍 Predict"):
    ...
    if prediction == 1:
        st.error("The model predicts a likelihood of heart disease. Please consult a healthcare professional for further evaluation.")
    else:
        st.success("The model predicts no significant likelihood of heart disease.")
